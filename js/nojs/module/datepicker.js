define("nojs/module/datepicker", [], function(require, $) {
    $.datepickerConfig = {
        ...
        setDay: function(date, num) {
            ...
            date += num * 24 * 60 * 60 * 1e3;
            return new Date(date);
        },
        onSelect: function(selectedDate) {
            var T = $.datepickerConfig, end = $("#end_date");
            if (end.length) {
                var isStart = this.id == "start_date", option = isStart ? "minDate" : "maxDate", instance = $(this).data("datepicker"), date = $.datepicker.parseDate(instance.settings.dateFormat || $.datepicker._defaults.dateFormat, selectedDate, instance.settings);
                ...
                if (isStart && !end.val()) {
                    ...
                    window.setTimeout(function() {
                        var D = new Date(date), y = D.getFullYear(), m = String(D.getMonth() + 1), d = String(D.getDate());
                        m = m.length < 2 ? "0" + m : m;
                        d = d.length < 2 ? "0" + d : d;
                        end.val(y + "-" + m + "-" + d).focus();
                    }, 10);
            ...
            $(this).data("date", true);
            //标记状态
            T.onChoose && T.onChoose.call(this, selectedDate);
        }
    };
    (function(a, b) {
        function c(b, c) {
    ...
    (function($, undefined) {
        ...
        function bindHover(a) {
            ...
            return a.bind("mouseout", function(a) {
                ...
                d.parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), d.addClass("ui-state-hover"), 
                d.hasClass("ui-datepicker-prev") && d.addClass("ui-datepicker-prev-hover"), d.hasClass("ui-datepicker-next") && d.addClass("ui-datepicker-next-hover");
            });
        }
        ...
        $.extend(Datepicker.prototype, {
            ...
            _attachments: function(a, b) {
                ...
                b.append && b.append.remove(), c && (b.append = $('<span class="' + this._appendClass + '">' + c + "</span>"), 
                a[d ? "before" : "after"](b.append)), a.unbind("focus", this._showDatepicker), b.trigger && b.trigger.remove();
                ...
                if (e == "button" || e == "both") {
                    ...
                    b.trigger = $(this._get(b, "buttonImageOnly") ? $("<img/>").addClass(this._triggerClass).attr({
                        ...
                        $.datepicker._showDatepicker(a[0])) : $.datepicker._showDatepicker(a[0]), !1;
                    });
                }
            },
            ...
            _inlineDatepicker: function(a, b) {
                ...
                c.addClass(this.markerClassName).append(b.dpDiv).bind("setData.datepicker", function(a, c, d) {
                    ...
                    return this._get(b, c);
                }), $.data(a, PROP_NAME, b), this._setDate(b, this._getDefaultDate(b), !0), this._updateDatepicker(b), 
            ...
            _dialogDatepicker: function(a, b, c, d, e) {
                ...
                if (!f) {
                    ...
                    f = this._dialogInst = this._newInst(this._dialogInput, !1), f.settings = {}, $.data(this._dialogInput[0], PROP_NAME, f);
                }
                extendRemove(f.settings, d || {}), b = b && b.constructor == Date ? this._formatDate(f, b) : b, 
                this._dialogInput.val(b), this._pos = e ? e.length ? e : [ e.pageX, e.pageY ] : null;
                if (!this._pos) {
                ...
                f.settings.onSelect = c, this._inDialog = !0, this.dpDiv.addClass(this._dialogClass), 
                this._showDatepicker(this._dialogInput[0]), $.blockUI && $.blockUI(this.dpDiv), 
                $.data(this._dialogInput[0], PROP_NAME, f), this;
            },
            _destroyDatepicker: function(a) {
                var b = $(a), c = $.data(a, PROP_NAME);
                if (!b.hasClass(this.markerClassName)) return;
                var d = a.nodeName.toLowerCase();
                $.removeData(a, PROP_NAME), d == "input" ? (c.append.remove(), c.trigger.remove(), 
            ...
            _optionDatepicker: function(a, b, c) {
                ...
                if (d) {
                    ...
                    extendRemove(d.settings, e), g !== null && e.dateFormat !== undefined && e.minDate === undefined && (d.settings.minDate = this._formatDate(d, g)), 
                    h !== null && e.dateFormat !== undefined && e.maxDate === undefined && (d.settings.maxDate = this._formatDate(d, h)), 
                    this._attachments($(a), d), this._autoSize(d), this._setDate(d, f), this._updateAlternate(d), 
            ...
            _doKeyDown: function(a) {
                ...
                if ($.datepicker._datepickerShowing) switch (a.keyCode) {
                  ...
                  case 37:
                    ...
                    c = a.ctrlKey || a.metaKey, a.originalEvent.altKey && $.datepicker._adjustDate(a.target, a.ctrlKey ? -$.datepicker._get(b, "stepBigMonths") : -$.datepicker._get(b, "stepMonths"), "M");
                    break;
            ...
            _showDatepicker: function(a) {
                ...
                $.datepicker._inDialog && (a.value = ""), $.datepicker._pos || ($.datepicker._pos = $.datepicker._findPos(a), 
                ...
                if (!b.inline) {
                    ...
                    b.dpDiv.zIndex($(a).zIndex() + 1), $.datepicker._datepickerShowing = !0, $.effects && $.effects[g] ? b.dpDiv.show(g, $.datepicker._get(b, "showOptions"), h, i) : b.dpDiv[g || "show"](g ? h : null, i), 
                    (!g || !h) && i(), b.input.is(":visible") && !b.input.is(":disabled") && b.input.focus(), 
            ...
            _checkOffset: function(a, b, c) {
                ...
                return b.left -= this._get(a, "isRTL") ? d - f : 0, b.left -= c && b.left == a.input.offset().left ? $(document).scrollLeft() : 0, 
                b.top -= c && b.top == a.input.offset().top + g ? $(document).scrollTop() : 0, b.left -= Math.min(b.left, b.left + d > h && h > d ? Math.abs(b.left + d - h) : 0), 
                b.top -= Math.min(b.top, b.top + e > i && i > e ? Math.abs(e + g) : 0), b;
            },
            _findPos: function(a) {
            ...
            _gotoToday: function(a) {
                ...
                if (this._get(c, "gotoCurrent") && c.currentDay) c.selectedDay = c.currentDay, c.drawMonth = c.selectedMonth = c.currentMonth, 
                c.drawYear = c.selectedYear = c.currentYear; else {
                    var d = new Date();
            ...
            _selectDate: function(a, b) {
                ...
                d.inline ? this._updateDatepicker(d) : (this._hideDatepicker(), this._lastInput = d.input[0], 
            ...
            parseDate: function(a, b, c) {
                ...
                var e = (c ? c.dayNamesShort : null) || this._defaults.dayNamesShort, f = (c ? c.dayNames : null) || this._defaults.dayNames, g = (c ? c.monthNamesShort : null) || this._defaults.monthNamesShort, h = (c ? c.monthNames : null) || this._defaults.monthNames, i = -1, j = -1, k = -1, l = -1, m = !1, n = function(b) {
                    ...
                    $.each(e, function(a, c) {
                        var d = c[1];
                        if (b.substr(r, d.length).toLowerCase() == d.toLowerCase()) return f = c[0], r += d.length, 
                        !1;
                    });
                    if (f != -1) return f + 1;
            ...
            _setDateFromField: function(a, b) {
                ...
                a.currentDay = d ? e.getDate() : 0, a.currentMonth = d ? e.getMonth() : 0, a.currentYear = d ? e.getFullYear() : 0, 
            ...
            _determineDate: function(a, b, c) {
                ...
                return f = f && f.toString() == "Invalid Date" ? c : f, f && (f.setHours(0), f.setMinutes(0), 
                f.setSeconds(0), f.setMilliseconds(0)), this._daylightSavingAdjust(f);
            },
            ...
            _generateHTML: function(a) {
                ...
                if (m) {
                    ...
                    p = l && p < l ? l : p;
                    while (this._daylightSavingAdjust(new Date(o, n, 1)) > p) n--, n < 0 && (n = 11, 
                    o--);
                }
                ...
                for (var L = 0; L < g[0]; L++) {
                    ...
                    for (var N = 0; N < g[1]; N++) {
                        ...
                        n++, n > 11 && (n = 0, o++), Q += "</tbody></table>" + (j ? "</div>" + (g[0] > 0 && N == g[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : ""), 
                        M += Q;
                    }
                    K += M;
                }
            ...
            _generateMonthYearHeader: function(a, b, c, d, e, f, g, h) {
                ...
                return l += this._get(a, "yearSuffix"), k && (l += (f || !i || !j ? "&#xa0;" : "") + m), 
                l += "</div>", l;
            },
