define("nojs/module/imgcrop", [], function(require, $) {
    $.Jcrop = function(obj, opt) {
        ...
        var Coords = function() {
            ...
            function getFixed() {
                ...
                max_x = options.maxSize[0] / xscale, max_y = options.maxSize[1] / yscale, rw = x2 - x1, rh = y2 - y1, rwa = Math.abs(rw), rha = Math.abs(rh), real_ratio = rwa / rha, xx, yy;
                if (max_x === 0) {
                    max_x = boundx * 10;
                }
                if (max_y === 0) {
