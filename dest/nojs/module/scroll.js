 ...
 * 无间断滚动
 */
define("nojs/module/scroll", [], function(require, $) {
    var scroll = function(id, opt) {
        ...
        this.view = Math.floor(this.size.box / this.size.item);
        //可见区域的个数	
        this.repeat = opt.repeat || false;
        //是否重复循环
        ...
        scroll: function(a) {
            ...
            if (this.direction == "x") {
                ...
                this.wrap.animate({
                    ...
                    if (T.wrap.scrollTop() >= T.size.item * (T.len - (T.repeat ? 0 : T.view))) {
