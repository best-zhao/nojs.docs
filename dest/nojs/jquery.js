define("nojs/jquery", [], function() {
    (function(a, b) {
        ...
        function b_(a, b, c, d) {
            ...
            for (;e < 4; e += 2) c === "margin" && (f += p.css(a, c + bU[e], !0)), d ? (c === "content" && (f -= parseFloat(bH(a, "padding" + bU[e])) || 0), 
        ...
        p.fn = p.prototype = {
            ...
            if (!d) {
                d = p.Deferred();
                if (e.readyState === "complete" || e.readyState !== "loading" && e.addEventListener) setTimeout(p.ready, 1); else if (e.addEventListener) e.addEventListener("DOMContentLoaded", D, !1), 
                ...
                if (a === b) {
                    if (this.length) {
                        ...
                        if (i.nodeType === 1 && !p._data(i, "parsedAttrs")) {
                            f = i.attributes;
                            for (h = f.length; j < h; j++) g = f[j].name, g.indexOf("data-") === 0 && (g = p.camelCase(g.substring(5)), 
                            J(i, g, k[g]));
        ...
        p.event = {
            ...
            dispatch: function(c) {
                ...
                if (q && (!c.button || c.type !== "click")) {
                    ...
                    for (f = c.target; f != this; f = f.parentNode || this) if (f.disabled !== !0 || c.type !== "click") {
                        i = {}, k = [], g[0] = f;
                        for (d = 0; d < q; d++) l = o[d], m = l.selector, i[m] === b && (i[m] = g.is(m)), 
                        i[m] && k.push(l);
                        k.length && u.push({
                            elem: f,
                            matches: k
                ...
                for (d = 0; d < u.length && !c.isPropagationStopped(); d++) {
                    ...
                    for (e = 0; e < j.matches.length && !c.isImmediatePropagationStopped(); e++) {
                        ...
                        c.handleObj = l, h = ((p.event.special[l.origType] || {}).handle || l.handler).apply(j.elem, r), 
            ...
            function bj(a, b, c) {
                var d, e, f = 0;
                for (;d = a[f]; f++) $.relative[d.part] ? e = bh(e, $.relative[d.part], b) : (d.captures.push(b, c), 
            ...
            var bl = Z.compile = function(a, b, c) {
                ...
                return g = O[a] = bk(e), g.context = b, g.runs = g.dirruns = 0, P.push(a), P.length > $.cacheLength && delete O[P.shift()], 
                g;
            };
            ...
            }(), Z.attr = p.attr, p.find = Z, p.expr = Z.selectors, p.expr[":"] = p.expr.pseudos, 
            p.unique = Z.uniqueSort, p.text = Z.getText, p.isXMLDoc = Z.isXML, p.contains = Z.contains;
        }(a);
        ...
        p.fn.extend({
            ...
            var f, g, h, i = a[0];
            return c = c || e, c = (c[0] || c).ownerDocument || c[0] || c, typeof c.createDocumentFragment == "undefined" && (c = e), 
            ...
            clean: function(a, b, c, d) {
                ...
                for (g = b === e && bA; (h = a[s]) != null; s++) {
                    ...
                    if (typeof h == "string") if (!br.test(h)) h = b.createTextNode(h); else {
                        g = g || bk(b), l = l || g.appendChild(b.createElement("div")), h = h.replace(bo, "<$1></$2>"), 
            ...
            b.webkit && (b.safari = !0), p.browser = b, p.sub = function() {
                function a(b, c) {
        ...
        p.fn.extend({
            ...
            style: function(a, c, d, e) {
                ...
                g = typeof d, g === "string" && (f = bQ.exec(d)) && (d = (f[1] + 1) * f[2] + parseFloat(p.css(a, c)), 
                g = "number");
            ...
            css: function(a, c, d, e) {
                ...
                return c = p.cssProps[i] || (p.cssProps[i] = bX(a.style, i)), h = p.cssHooks[c] || p.cssHooks[i], 
                h && "get" in h && (f = h.get(a, !0, e)), f === b && (f = bH(a, c)), f === "normal" && c in bT && (f = bT[c]), 
            ...
            return g && (c = g[b], c === "" && !p.contains(a.ownerDocument.documentElement, a) && (c = p.style(a, b)), 
            bP.test(c) && bN.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = c, 
            c = g.width, h.width = d, h.minWidth = e, h.maxWidth = f)), c;
        } : e.documentElement.currentStyle && (bH = function(a, b) {
            var c, d, e = a.currentStyle && a.currentStyle[b], f = a.style;
            return e == null && f && f[b] && (e = f[b]), bP.test(e) && !bM.test(b) && (c = f.left, 
        ...
        cj = cs.exec(ci.toLowerCase()) || [], p.fn.load = function(a, c, d) {
            ...
            c = b) : typeof c == "object" && (f = "POST"), p.ajax({
                url: a,
                type: f,
                dataType: "html",
                data: c,
            ...
            ajax: function(a, c) {
                function y(a, c, f, i) {
                    ...
                    a === 304 ? (y = "notmodified", k = !0) : (k = cC(l, u), y = k.state, s = k.data, 
                    t = k.error, k = !t); else {
                        t = y;
                ...
                o.promise(x), x.success = x.done, x.error = x.fail, x.complete = q.add, x.statusCode = function(a) {
                    ...
                    return this;
                }, l.url = ((a || l.url) + "").replace(ck, "").replace(co, cj[1] + "//"), l.dataTypes = p.trim(l.dataType || "*").toLowerCase().split(s), 
                ...
                p.etag[d] && x.setRequestHeader("If-None-Match", p.etag[d])), x.setRequestHeader("Accept", l.dataTypes[0] && l.accepts[l.dataTypes[0]] ? l.accepts[l.dataTypes[0]] + (l.dataTypes[0] !== "*" ? ", " + cw + "; q=0.01" : "") : l.accepts["*"]);
        ...
        p.ajaxSetup({
            ...
            g = a[f], l ? c.url = j.replace(cF, "$1" + f) : m ? c.data = i.replace(cF, "$1" + f) : k && (c.url += (cE.test(j) ? "&" : "?") + c.jsonp + "=" + f), 
            c.converters["script json"] = function() {
                return h || p.error(f + " was not called"), h[0];
            }, c.dataTypes[0] = "json", a[f] = function() {
                h = arguments;
            }, e.always(function() {
                a[f] = g, c[f] && (c.jsonpCallback = d.jsonpCallback, cD.push(f)), h && p.isFunction(g) && g(h[0]), 
                h = g = b;
            }), "script";
        }), p.ajaxSetup({
            accepts: {
        ...
        p.Animation = p.extend(cV, {
            ...
            run: function(a) {
                ...
                c && c.set ? c.set(this) : cY.propHooks._default.set(this), this;
            }
        ...
        p.fn.offset = function(a) {
            ...
            if (!n) return;
            return (e = n.body) === m ? p.offset.bodyOffset(m) : (d = n.documentElement, p.contains(d, m) ? (c = m.getBoundingClientRect(), 
            f = c_(n), g = d.clientTop || e.clientTop || 0, h = d.clientLeft || e.clientLeft || 0, 
            i = f.pageYOffset || d.scrollTop, j = f.pageXOffset || d.scrollLeft, k = c.top + i - g, 
            l = c.left + j - h, {
                top: k,
                left: l
            }) : {
 ...
 * nolure@vip.qq.com
 */
define("nojs/ui", [], function(require, $) {
    var UI = {};
    /*
	 * 触发方式
	 * 1.普通：直接执行相关方法，
    ...
    UI.select = function(dom, opt) {
        ...
        //切换回调
        this.defaultEvent = opt.defaultEvent == true ? true : false;
        //首次是否执行回调
    ...
    UI.select.prototype = {
        setCon: function() {
            var HTML = this.box.html().replace(/OPTION|option/g, "li"), list = this.box.find("option"), html = "", m, link, style = this.box.attr("style"), v = this.box.attr("val") || this.box.val() || 0, id = this.box[0].id || "", i, j;
        ...
        init: function(I) {
            ...
            var _m, at, d = this.hide.val(), pd = parseInt(this.m_on.css("padding-left")) + parseInt(this.m_on.css("padding-right")), w1, w2 = 0, w3;
        ...
        bindEvent: function() {
            ...
            this.box.hover(function() {
                ...
                A = window.setTimeout(function() {
                    T.menu.hide();
                    //.slideUp(150,'easeOutExpo');
                    T.box.removeClass("nj_select_hover");
                }, 200);
            });
            this.menu.click(function(e) {
                var m = e.target, text = $(m).text(), v = m.getAttribute("value");
    ...
    UI.select.batch = function(box, opt) {
        ...
        var s = box.find("select"), m, id, arr = [], n = s.length, d;
        if (!n) {
            return;
        }
        for (var i = 0; i < n; i++) {
    ...
    UI.Switch.prototype = {
        ...
        bind: function() {
            var T = this, A, m, delay = T.mode == "mouseover" ? 100 : 0;
            //延迟触发
    ...
    UI.menu.prototype = {
        ...
        bind: function() {
            var T = this, s = this.mode == "mouseover", delay = s || this.mode == "focus" ? 60 : 0, top, left, A, B;
            if (!this.agent) {
    ...
    if ($.browser("ie6 ie7 ie8 ie9")) {
        $(function() {
            var ph = $("[placeholder]"), i, len = ph.length;
            if (len) {
                for (i = 0; i < len; i++) {
